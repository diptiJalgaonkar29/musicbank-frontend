...
const defaultDismissTime = 4000; // 4 seconds
...
export function setNotificationTopBar(payload) {
  return { type: SET_NOTIFICATION_TOP_BAR, payload };
}

export function resetNotificationTopBar() {
  return { type: RESET_NOTIFICATION_TOP_BAR };
}
