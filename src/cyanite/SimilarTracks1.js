...
class SimilarTracks1 extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      jsonData: null,
  ...
  render() {
    ...
    //InitAudioEditor(`{track.preview_track_url}`);

    return (
      <>
        {/* <AudioWaveformEditor trackURL={track.preview_track_url}/> */}
