...
import CyaniteSearchBlockCard from "../../cyanite/components/CyaniteSearchBlockCard";
import SpotifySearchBlockCard from "../../cyanite/components/SpotifySearchBlockCard";
...
import "./SimilaritySearchView.css";
...
class SimilaritySearchView extends React.Component {
  constructor(props) {
    super(props);
    selfThis = this;
  ...
  render() {
    ...
    return (
      <BrandingContext.Consumer>
        {({ config }) => (
          <>
            <div className="ai-search-container" style={{ margin: "0 auto" }}>
              <div className="ai-search-container-inner">
                ...
                <div className="st-filter-header-wrapper">
                  <div className="st-filter-header">
                    <div className="st-filter-lp">
                      <p className="st-filter-para">Reference track</p>
                    ...
                    <div className="st-filter-rp">
                      ...
                      <div>
                        <button
                          className={`st-filter-btn st-btn-spotify ${
                            this.state.stSearchTo === "spotify" ? "active" : ""
                          }`}
                        ...
                        <button
                          className={`st-filter-btn st-btn-library ${
                            this.state.stSearchTo === "library" ? "active" : ""
                          } `}
                  ...
                  <div className="st-filter-rp-inner st-filter-cp">
                    ...
                    >
                      <SpotifySearch2
                        fetchSimilarFromSpotify={this.fetchSimilarFromSpotify}
                        setShowDropDown={this.setShowDropDown}
...
export default connect(mapStateToProps, null)(SimilaritySearchView);
